...
RESULT RedisHsetAndPush(PXMLSTRU  pstruXml)
{
    ...
    //2022.1.4
    cJSON_AddNumberToObject(cjson_log, "qs_netflag",  	atoi(DemandStrInXmlExt(pstruXml, "<omc>/<序列号>")));
	cJSON_AddNumberToObject(cjson_log, "ne_repeaterid",  atol(DemandStrInXmlExt(pstruXml, "<omc>/<站点编号>"))); 
	cJSON_AddNumberToObject(cjson_log, "ne_deviceid",  	 atoi(DemandStrInXmlExt(pstruXml, "<omc>/<设备编号>")));
